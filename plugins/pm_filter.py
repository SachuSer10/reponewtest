...
async def next_page(bot, query):
    ...
    if n_offset == 0:
        ...
        btn.append(
            [InlineKeyboardButton("Pᴀɢᴇ", callback_data=f"next_{req}_{key}_{off_set}"),
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('Sᴏᴜʀᴄᴇs', callback_data='source')
        ], [
            InlineKeyboardButton('Hᴏᴍᴇ', callback_data='start'),
...
async def auto_filter(client, msg, spoll=False):
    ...
    if offset != "":
        ...
        btn.append(
            [InlineKeyboardButton(text=f"Pᴀɢᴇ", callback_data="pages"),
    ...
    if imdb:
        ...
        cap = f"<b>Hey 👋🏻 {message.from_user_channel.mention} 😍\n\n<i>🔖 Title : {search}\n📫 Your Files is Ready Now</i></b>"
